!function (e) {
    ...
    var a, e = navigator.userAgent, R = /iphone/i.test(e), S = /chrome/i.test(e), T = /android/i.test(e);
    A.mask = {
        ...
        caret: function (e, t) {
            ...
            return p = A.extend({
                ...
                completed: null
            }, p), n = A.mask.definitions, v = [], b = x = t.length, k = null, t = String(t), A.each(t.split(""), function (e, t) {
                "?" == t ? (x--, b = e) : n[t] ? (v.push(new RegExp(n[t])), null === k && (k = v.length - 1), e < b && (y = v.length - 1)) : v.push(null)
            }), this.trigger("unmask").each(function () {
                var o = A(this), c = A.map(t.split(""), function (e, t) {
                ...
                function d(e) {
                    for (var t, n = o.val(), a = -1, i = 0, r = 0; i < x; i++) if (v[i]) {
                        for (c[i] = u(i); r++ < n.length;) if (t = n.charAt(r - 1), v[i].test(t)) {
                            c[i] = t, a = i;
                            break
                        }
                        if (r > n.length) {
                ...
                o.data(A.mask.dataName, function () {
                    ...
                    var e;
                    o.prop("readonly") || (clearTimeout(a), i = o.val(), e = d(), a = setTimeout(function () {
                        o.get(0) === document.activeElement && (m(), e == t.replace("?", "").length ? o.caret(0, e) : o.caret(e))
                    }, 10))
                }).on("blur.mask", h).on("keydown.mask", function (e) {
                    var t, n, a;
                    o.prop("readonly") || (t = e.which || e.keyCode, j = o.val(), 8 === t || 46 === t || R && 127 === t ? (n = (a = o.caret()).begin, (a = a.end) - n == 0 && (n = 46 !== t ? function (e) {
                        for (; 0 <= --e && !v[e];) ;
                        return e
                    }(n) : a = s(n - 1), a = 46 === t ? s(a) : a), g(n, a), f(n, a - 1), e.preventDefault()) : 13 === t ? h.call(this, e) : 27 === t && (o.val(i), o.caret(0, d()), e.preventDefault()))
                }).on("keypress.mask", function (e) {
                    var t, i, n, a;
                    o.prop("readonly") || (a = e.which || e.keyCode, t = o.caret(), e.ctrlKey || e.altKey || e.metaKey || a < 32 || a && 13 !== a && (t.end - t.begin != 0 && (g(t.begin, t.end), f(t.begin, t.end - 1)), (i = s(t.begin - 1)) < x && (a = String.fromCharCode(a), v[i].test(a) && (function () {
                        for (var e, t, n = i, a = u(i); n < x; n++) if (v[n]) {
                            if (e = s(n), t = c[n], c[n] = a, !(e < x && v[e].test(t))) break;
                            a = t
                        }
                    }(), c[i] = a, m(), n = s(i), T ? setTimeout(function () {
                        A.proxy(A.fn.caret, o, n)()
                    }, 0) : o.caret(n), t.begin <= y && r())), e.preventDefault()))
                }).on("input.mask paste.mask", function () {
                    o.prop("readonly") || setTimeout(function () {
                        var e = d(!0);
                        o.caret(e), r()
                    }, 0)
                }), S && T && o.off("input.mask").on("input.mask", function (e) {
